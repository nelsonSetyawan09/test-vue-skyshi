<template>
  <div class="detail flex justify-center mx-auto bg-[#E5E5E5] h-screen w-full">
    <div class="w-[1000px] pt-10 ">
      <div v-if="loading" class="mt-20">... loading</div>
      <div v-else>
        <header class="flex justify-between items-center">
          ...
          <button @click.stop="showModal" class="bg-[#16ABF8] px-5 py-2.5 text-white rounded-3xl text-lg">
