    ...
    >
        <div class="mt-2 flex flex-col items-center gap-3 p-4">
            ...
            <div class="flex gap-4 mt-3">
                ...
                <button @click.stop="deleteData" class="bg-[#ED4C5C] w-[150px] px-4 py-2 text-white rounded-3xl text-lg">
